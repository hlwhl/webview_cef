...
function(download_file url filename)
    ...
    if(NOT _dl_code EQUAL 0)
        message(FATAL_ERROR "Failed to download CEF bundle from ${url}. STATUS=${dl_status}. Check network/proxy or set up the bundle manually in third/cef.")
    endif()
...
function(prepare_prebuilt_files filepath)
    ...
    if(need_download)
        ...
        set(_cef_archive ${CMAKE_CURRENT_SOURCE_DIR}/prebuilt.tar.bz2)
